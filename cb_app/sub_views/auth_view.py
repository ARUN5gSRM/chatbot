...
def signup_view(request):
    ...
    # templates is under cb_app/templates/cb_app/signup.html
    return render(request, "cb_app/signup.html", {"form": form})
...
def login_view(request):
    ...
    # templates is under cb_app/templates/cb_app/login.html
    return render(request, "cb_app/login.html", {"form": form})
